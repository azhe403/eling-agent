...
public class TagNormalizationTests
{
    ...
    {
        var result = Memory.NormalizeTags(new[] { "git-hygiene" });
    ...
    {
        var result = Memory.NormalizeTags(new[] { "code_review" });
    ...
    {
        var result = Memory.NormalizeTags(new[] { "eling.mcp" });
    ...
    {
        var result = Memory.NormalizeTags(new[] { "work/worktree" });
    ...
    {
        var result = Memory.NormalizeTags(new[] { "GIT-Hygiene", "CODE_REVIEW" });
    ...
    {
        var result = Memory.NormalizeTags(new[] { "a", "bc", "def-g" });
    ...
    {
        var result = Memory.NormalizeTags(new[] { "git", "Git", "GIT", "hygiene" });
        Assert.Equal(new[] { "git", "hygiene" }, result);
    }
    ...
    {
        var result = Memory.NormalizeTags(null);
        Assert.Empty(result);
    }
    ...
    {
        var result = Memory.NormalizeTags(new[] { "  spaced  tag  ", "" });
    ...
    {
        var result = Memory.NormalizeTags(new[] { "some_tag-name.with/many" });
    ...
    {
        var result = Memory.NormalizeTags(new[] { "zebra", "apple", "mango" });
