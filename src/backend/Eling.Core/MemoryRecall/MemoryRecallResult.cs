...
/// topics) and carries the matched-layer metadata. <see cref="RecentMemories"/>
/// is the most recently updated active memories across the requested scope,
/// useful for surfacing new writes performed by other agents.
/// </summary>
