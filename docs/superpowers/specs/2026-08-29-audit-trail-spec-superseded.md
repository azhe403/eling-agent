> **SUPERSEDED (2026-09-11).** Replaced by `docs/superpowers/specs/2026-09-11-audit-trail-design.md`.
> Kept for historical reference only. Its Vestige-mirror assumption was never implementable and
> its scope covered only mutations.
